...
// import { SplitText } from "https://cdn.skypack.dev/gsap@3.12.5/SplitText.js";
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const descSplits = new SplitText(".tooltip .description p" , {
        type: "lines",
        linesClass: "line"
    });
    ...
    [...titleSplits.lines, ...descSplits.lines].forEach(
...
new GLTFLoader().load("/monster1.glb", (gltf) => {
    model = gltf.scene;
